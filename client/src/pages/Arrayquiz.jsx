...
export default function Arrayquiz() {
  ...
  const questions = [
    ...
    {
      id: 3,
      question: "What is the maximum index of the first element in an array in C?",
      options: [
        { id: 1, text: "0" },
        { id: 2, text: "1" },
        { id: 3, text: "-1" },
    ...
    {
      id: 4,
      question: "Which of the following is the correct syntax to pass an array as a function argument?",
      options: [
  ...
  return (
    <div className="flex justify-center h-screen items-center flex-col">
                ...
                <li key={option.id} className="mb-2">
                  <label className="flex items-center">
                    <input
                      ...
                      disabled={submitted || selectedOptions[q.id]}
                    />
                    {option.text}
                  </label>
                </li>
      ...
      {score === 5 && nextLevelUnlocked && ( // Conditionally render next level button if score is 5 and next level is unlocked
        <Link
          to="/Operators"
          className="btn bg-yellow-300 text-black px-4 py-2 rounded-md"
        >
